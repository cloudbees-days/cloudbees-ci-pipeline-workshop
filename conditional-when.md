...
You may proceed to the next lab [*Lab 5. Inline Pipeline Pod Templates*](./inline-pipeline-pod-templates.md) or head back to the main list of the [**labs**](./README.md#workshop-labs) when you are ready.
