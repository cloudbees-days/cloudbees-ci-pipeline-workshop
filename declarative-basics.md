...
>NOTE: If we hadn't added the **GitHub server** configuration above then the GitHub webhook would not be automatically create for us and we would have to create it manually.
