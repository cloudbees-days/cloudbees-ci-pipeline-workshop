...
7. **Select team master creation recipe** - click on the drop-down to see the options, but select the top option: **Workshop Default** recipe;<p><img src="img/setup/setup-create-team-recipe-2.png" width=450/>
8. Finally, click the **Create team** button. <p><img src="img/setup/setup-create-team.png" width=450/>
