...
1. Open the GitHub editor for the **Jenkinsfile** Pipeline script in the **development** branch of your forked **helloworld-nodejs** repository.
...
2. Open the GitHub editor for the **Jenkinsfile** file in the **development** branch of your forked **helloworld-nodejs** repository.
...
4. Commit the changes and then navigate to the **development** branch of your **helloworld-nodejs** job in Blue Ocean on your Team Master. 
...
5. Now I will run the **hello-api** job and everyone should see the **development** branch of their **helloworld-nodejs** job triggered. <p><img src="img/cross-team/cross_team_triggered_by_event.png" width=850/>
